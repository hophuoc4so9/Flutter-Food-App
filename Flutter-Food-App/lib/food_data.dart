// Nơi cấu hình dữ liệu các món ăn theo từng danh mục.
// Bạn có thể thoải mái thêm/xóa/sửa các món ăn và đường dẫn ảnh ở file này nhé!

final Map<String, List<Map<String, dynamic>>> foodMenuData = {
  "Chinese": [
    {
      "name": "Vịt Quay Băc Kinh",
      "description": "",
      "price": "\$12.99",
      "image": "assets/vit_quay_bac_kinh.jpg", // <--- Sửa đường dẫn ảnh mới của bạn tại đây
    },
    {
